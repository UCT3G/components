<template>
  <div class="animate__animated animate__fadeIn animate__faster">
    ...
    <ConfigSection 
      ...
      :is-open="sectionsOpen.origen"
      @toggle="toggleSection('origen')"
    >
      <div class="mb-3">
    ...
    <div v-if="selectedTableName">
      ...
      <ConfigSection 
        ...
        :is-open="sectionsOpen.ejes"
        @toggle="toggleSection('ejes')"
      >
        <div class="mb-3">
      ...
      <ConfigSection 
        ...
        :is-open="sectionsOpen.agrupacion"
        @toggle="toggleSection('agrupacion')"
      >
        <div class="mb-3">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    const { sectionsOpen, toggleSection } = useChartsAccordion({
        origen: true // Por defecto abrir origen en consulta
    });
