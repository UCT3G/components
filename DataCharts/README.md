...
```vue
<DataVisualizer
  :allowedTables="['TB_GT_BSC_RESULTADOS', 'TB_GT_BSC_RANKING_SUCURSALES']"
/>
```
...
<template>
  ...
  <DataVisualizer fixedTableName="TB_GT_KPIS" :externalDataTrigger="trigger" />
</template>
...
Se seleccionan desde el panel lateral (Tab _Estilo_):
...
[useDataCharts.js] [ChartsConfig.vue]
(estado central) (UI configuración)
│ │
│ ├── TabConsulta (ejes, groupBy)
│ └── TabEstilo (tipo gráfica)
│
▼
...
[Tabla dinámica] [EChartsVisualizer.vue]
│
▼
(render gráfico)
